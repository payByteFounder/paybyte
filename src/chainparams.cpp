...
{
    // PayByte genesis message. Changing this changes the genesis hash.
...
public:
    CMainParams() {
        ...
        // PayByte monetary policy (target: 10,000,000 max supply).
        // Total supply ~= 2 * (halving interval) * (initial subsidy). With 50 coins initial subsidy:
        // 2 * 100,000 * 50 = 10,000,000.
        consensus.nSubsidyHalvingInterval = 416667; // ~10,000,000 max supply with 12 PBE start subsidy

        // Brand-new chain: activate modern rules from genesis.
        ...
        // Disabled by default for PayByte (enable later if you want).
        ...
        // Disabled by default for PayByte.
         ...
         */
        // PayByte network magic (do not reuse Litecoin/Bitcoin values).
        ...
        genesis = CreateGenesisBlock(1771632000, 681144, 0x1e0fffff, 1, 12 * COIN);
        consensus.hashGenesisBlock = uint256S("0x28fa569b53badb07842109b5e95d1fafeb4f277ee010fe309cb2f22aeb703bac");

        assert(consensus.hashGenesisBlock == genesis.GetHash());
        assert(genesis.hashMerkleRoot == uint256S("0x3efbe892cabf1d0e527c1233a995a75fe3c1fba840ab4e12b7498771398d529c"));

        // ---- DNS Seeds ----
        vSeeds.clear();
        vFixedSeeds.clear();
        vSeeds.emplace_back("node.paybyte.org");
...
public:
    CTestNetParams() {
        ...
        // Activate from genesis on PayByte testnet as well.
        consensus.BIP16Height = 1;
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = 1;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // Deployment of MWEB (disabled by default for PayByte)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        ...
        genesis = CreateGenesisBlock(1771632000, 2, 0x207fffff, 1, 12 * COIN);
        consensus.hashGenesisBlock = uint256S("0x752c85eda1a87136c828caac42341db9348032ad94e9fef676308419b57068d6");
        assert(consensus.hashGenesisBlock == genesis.GetHash());
        assert(genesis.hashMerkleRoot == uint256S("0x3efbe892cabf1d0e527c1233a995a75fe3c1fba840ab4e12b7498771398d529c"));
